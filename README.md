...
**TDD Practice** is a program where you see methods who solve problem.
...
- **Add Solver class**
- **Add test for factorial method**
- **Add test for reverse method**
- **Add test for Fizzbuz method**
...
```sh
  cd my-folder
  git clone https://github.com/rbd3/TDD-Practice.git
```
--->
<!--
### Install
...
Feel free to check the [issues page](https://github.com/rbd3/TDD-Practice/issues).
